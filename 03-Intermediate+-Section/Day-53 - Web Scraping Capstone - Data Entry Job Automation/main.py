...
## List of all the prices on the page using a CSS Selector
...
for n in range(len(all_links)):
    ...
    driver.get("https://docs.google.com/forms/d/e/1FAIpQLSeCzUsVm79GC4EAKiHIUJxMqSgvw6ZFO1csMiWOGpZSnZN58w/viewform?usp=header")
    time.sleep(2)
